<?php 
    ...
    $sql = $conexao->prepare(
                           "SELECT vendedores.id_vendedor, vendedores.nome_vendedor, vendedores.banner, vendedores.foto, vendedores.apresentacao, vendedores.telefone_contato, vendedores.abertura, vendedores.fechamento, vendedores.vendas, vendedores.itens_a_venda, 
